...
inherit autotools libtool flag-o-matic git-r3 python-any-r1

DESCRIPTION="Lightweight library for extracting data from files archived in a single zip file"
HOMEPAGE="http://zziplib.sourceforge.net/"

EGIT_REPO_URI="https://github.com/gdraheim/zziplib.git"
EGIT_BRANCH="master"
...
PATCHES=(
	...
	"${FILESDIR}"/${PN}-0.13.69_p20190804-pr83.patch
)
